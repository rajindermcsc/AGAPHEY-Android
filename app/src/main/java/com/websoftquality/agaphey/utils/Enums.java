package com.websoftquality.agaphey.utils;
/**
...
public class Enums {
    public static final String MY_PHONE_NUMBER = "com.websoftquality.agaphey.views.signup.PhoneNumberFragment";
    public static final String ONE_TIME_PWD = "com.websoftquality.agaphey.views.signup.OneTimePwdFragment";
    ...
    public static final int REQ_EMAIL_SIGNUP = 137;
    ...
    @StringDef({MY_PHONE_NUMBER, ONE_TIME_PWD})
    ...
    @IntDef({REQ_GET_LOGIN_SLIDER, REQ_FB_SIGNUP, REQ_VERIFY_NUMBER, REQ_NUMBER_SIGNUP, REQ_GET_EDIT_PROFILE, REQ_UPLOAD_PROFILE_IMG,
            ...
            REQ_SWIPE_MATCH, REQ_UPDATE_LOCATION, REQ_SHOW_ALL_MATCHES, REQ_LOGOUT, REQ_MSG_CONVERSATION, REQ_SEND_MSG,REQ_EMAIL_SIGNUP})
    @Retention(RetentionPolicy.SOURCE)
