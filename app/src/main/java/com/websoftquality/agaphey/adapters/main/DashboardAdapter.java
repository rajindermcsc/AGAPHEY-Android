...
public class DashboardAdapter extends RecyclerView.Adapter{
    ...
    public DashboardAdapter(Context context, JSONObject jsonObject) {
...
//            count=jsonObject.getJSONArray("data").length();
    ...
    @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.dashboard_list_adapter, parent, false);
