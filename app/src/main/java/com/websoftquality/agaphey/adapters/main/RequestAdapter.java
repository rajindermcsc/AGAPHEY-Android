package com.websoftquality.agaphey.adapters.main;
...
public class RequestAdapter extends RecyclerView.Adapter{
    ...
    public RequestAdapter(Context context, JSONObject jsonObject) {
        this.context=context;
        this.jsonObject=jsonObject;
        try {
            Log.e("TAG", "RequestAdapter: "+jsonObject);
//            count=jsonObject.getJSONArray("data").length();
    ...
    @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.dashboard_list_request_adapter, parent, false);
