package com.websoftquality.agaphey.views.main.AccountKit;
...
import com.websoftquality.agaphey.datamodels.main.LoginModel;
import com.websoftquality.agaphey.datamodels.main.NumberValidationModel;
...
import static com.websoftquality.agaphey.configs.Constants.FACEBOOK_ACCOUNT_KIT_PHONE_NUMBER_COUNTRY_CODE_KEY;
import static com.websoftquality.agaphey.configs.Constants.FACEBOOK_ACCOUNT_KIT_PHONE_NUMBER_KEY;
...
*/
    ...
    void callPhoneNumberValidationAPI(String facebookVerifiedPhoneNumber, String facebookVerifiedCountryCode) {
        ...
        apiService.verifyPhoneNumber(facebookVerifiedPhoneNumber, "","").enqueue(new RequestCallback(REQ_VERIFY_NUMBER, this));
    }
