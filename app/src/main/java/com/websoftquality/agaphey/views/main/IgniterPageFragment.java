...
import com.websoftquality.agaphey.datamodels.matches.MatchesResponse;
import com.websoftquality.agaphey.datamodels.matches.MatchingProfile;
...
import com.websoftquality.agaphey.swipedeck.SwipeDeck;
import com.websoftquality.agaphey.swipedeck.layouts.SwipeRelativeLayout;
...
import com.websoftquality.agaphey.views.customize.RippleBackground;
...
import static com.websoftquality.agaphey.utils.Enums.MATCH_LIKE;
import static com.websoftquality.agaphey.utils.Enums.MATCH_NOPE;
import static com.websoftquality.agaphey.utils.Enums.MATCH_REWIND;
import static com.websoftquality.agaphey.utils.Enums.MATCH_SUPER_LIKE;
...
import static com.websoftquality.agaphey.utils.Enums.REQ_UPDATE_BOOST_USER;
...
public class IgniterPageFragment extends Fragment implements View.OnClickListener, ServiceListener, IabBroadcastReceiver.IabBroadcastListener {
    ...
    public void onViewCreated(View v, Bundle savedInstanceState) {
        ...
        rl_main_data = view.findViewById(R.id.rl_main_data);
            ...
            case REQ_SHOW_ALL_MATCHES:
                if (jsonResp.isSuccess()) {
                    ...
                    if (matchProfilesModel.getUser_status().equalsIgnoreCase("active")){
                        ...
                        rl_main_data.setVisibility(View.VISIBLE);
                    }
                    else {
