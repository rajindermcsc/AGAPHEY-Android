...
public class OneTimePwdFragment extends Fragment implements View.OnClickListener, ServiceListener {
    ...
    private void initView() {
        ...
        tv_accept_terms = view.findViewById(R.id.tv_accept_terms);

        edtCode1 = view.findViewById(R.id.edt_code1);
        edtCode2 = view.findViewById(R.id.edt_code2);
        edtCode3 = view.findViewById(R.id.edt_code3);
        edtCode4 = view.findViewById(R.id.edt_code4);
        edtCode5 = view.findViewById(R.id.edt_code5);
        edtCode6 = view.findViewById(R.id.edt_code6);
