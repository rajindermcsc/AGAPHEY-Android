package com.websoftquality.agaphey.views.profile;
/**
...
import com.websoftquality.agaphey.datamodels.main.LocationModel;
import com.websoftquality.agaphey.datamodels.main.SettingsModel;
import com.websoftquality.agaphey.iaputils.IabBroadcastReceiver;
import com.websoftquality.agaphey.iaputils.IabHelper;
import com.websoftquality.agaphey.iaputils.IabResult;
import com.websoftquality.agaphey.iaputils.Inventory;
import com.websoftquality.agaphey.iaputils.Purchase;
import com.websoftquality.agaphey.interfaces.ApiService;
import com.websoftquality.agaphey.interfaces.OnRangeSeekBarChangeListener;
import com.websoftquality.agaphey.interfaces.OnRangeSeekBarFinalValueListener;
import com.websoftquality.agaphey.interfaces.OnSeekBarChangeListener;
import com.websoftquality.agaphey.interfaces.OnSeekBarFinalValueListener;
...
import com.websoftquality.agaphey.views.customize.CustomLayoutManager;
import com.websoftquality.agaphey.views.customize.CustomRecyclerView;
import com.websoftquality.agaphey.views.customize.CustomSeekBar;
import com.websoftquality.agaphey.views.customize.RangeSeekBar;
...
import static com.websoftquality.agaphey.utils.Enums.REQ_ADD_LOCATION;
import static com.websoftquality.agaphey.utils.Enums.REQ_GET_SETTINGS;
import static com.websoftquality.agaphey.utils.Enums.REQ_LOGOUT;
import static com.websoftquality.agaphey.utils.Enums.REQ_UPDATE_SETTINGS;
...
public class SettingsActivity extends AppCompatActivity implements IabBroadcastReceiver.IabBroadcastListener, View.OnClickListener, RadioGroup.OnCheckedChangeListener, ServiceListener, CompoundButton.OnCheckedChangeListener {
    ...
    private CustomTextView tvLicense, tvPrivacyPolicy, tvTermsService, men_women,tv_blog;
    ...
    private String profileUrl = "", helpUrl = "", licenseUrl = "", privacyPolicyUrl = "", termsOfServiceUrl = "", communityUrl = "", safetyUrl = "", message = "",blogurl="";
    ...
    private void initView() {
        ...
        blogurl = getResources().getString(R.string.redirect_url) + "" + getResources().getString(R.string.blog);
