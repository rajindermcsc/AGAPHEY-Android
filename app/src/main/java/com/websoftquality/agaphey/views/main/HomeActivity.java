...
import com.websoftquality.agaphey.ForumFragment;
...
import com.websoftquality.agaphey.datamodels.chat.ReceiveDateModel;
import com.websoftquality.agaphey.interfaces.ActivityListener;
import com.websoftquality.agaphey.pushnotification.Config;
...
import com.websoftquality.agaphey.views.ChatGroupFragment;
import com.websoftquality.agaphey.views.chat.ChatFragment;
import com.websoftquality.agaphey.views.customize.CustomDialog;
import com.websoftquality.agaphey.views.customize.IgniterViewPager;
import com.websoftquality.agaphey.views.customize.SwipeDirection;
 ...
 ****************************************************************/
public class HomeActivity extends AppCompatActivity implements ActivityListener, ViewPager.OnPageChangeListener, TabLayout.BaseOnTabSelectedListener {
...
//            tabLayout.getTabAt(2).setIcon(R.drawable.ic_send_request);
            tabLayout.getTabAt(2).setCustomView(getTabView(R.string.ic_favorite,0));
            tabLayout.getTabAt(3).setCustomView(getTabView(R.string.ic_chat_1, 0));
//            tabLayout.getTabAt(4).setCustomView(getTabView(R.string.ic_chat, 0));
            tabLayout.getTabAt(4).setIcon(R.drawable.ic_forum);


//            tabLayout.getTabAt(4).setCustomView(getTabView(R.string.ic_favorite,0));

//            tabLayout.getTabAt(0).setCustomView(getTabView(R.string.ic_user_black_bg, 0));
//            tabLayout.getTabAt(1).setCustomView(getTabView(R.string.ic_hot_or_burn, 1));
//            tabLayout.getTabAt(2).setCustomView(getTabView(R.string.ic_hot_or_burn, 1));
//            tabLayout.getTabAt(3).setCustomView(getTabView(R.string.ic_chat_1, 0));
//            tabLayout.getTabAt(4).setCustomView(getTabView(R.string.ic_chat_1, 0));
    ...
    public void onPageSelected(int position) {
        ...
        switch (position)
        {
            case 0:
                ...
                tabLayout.setTabIconTint(ColorStateList.valueOf(getResources().getColor(R.color.gray1)));
                break;
            case 1:
            ...
            case 3:
                ...
                break;
            case 4:
                tabLayout.setTabIconTint(ColorStateList.valueOf(getResources().getColor(R.color.color_accent)));
                break;
...
//            igniterPageFragment.onRequestPermissionsResult(requestCode, permissions, grantResults);
        ...
        if(dashboardFragment!=null)
            dashboardFragment.onRequestPermissionsResult(requestCode, permissions, grantResults);
    }
    ...
    private class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                ...
                case 2:
                    return new ActionRequestFragment();
                case 3:
