...
-keep public class com.websoftquality.agaphey.datamodels.** {*;}
-keep class com.websoftquality.agaphey.views.main.LoginActivity
-keep class com.websoftquality.agaphey.utils.** {*;}
-keepclasseswithmembernames class com.websoftquality.agaphey.utils.** {*;}
